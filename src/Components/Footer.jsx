    ...
    <div className="max-w-[1240px] mx-auto py-16 px-4 grid lg:grid-cols-3 gap-8 text-gray-300">
      <div>
        ...
        <p className="py-4">
          ...
          natus inventore cumque praesentium aliquid. Inventore, iusto eveniet.
          Soluta similique fugiat provident fuga doloribus temporibus sapiente
          aliquid iure, laboriosam dolorum!
              </p>
